...
const init = () => {
  ...
  chart_js__WEBPACK_IMPORTED_MODULE_2___default.a.defaults.global.elements.line.borderWidth = 2;
  ...
  const activity = jquery__WEBPACK_IMPORTED_MODULE_1___default()(_lotka_pug__WEBPACK_IMPORTED_MODULE_0___default()());

  const lotkaChart = new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a(activity.find('#lotkachart'), {
    type: 'line',
    data: {
      datasets: [{
