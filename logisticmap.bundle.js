...
/* harmony import */ var _templates_logisticmap_pug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./templates/logisticmap.pug */ "./src/modules/logisticmap/templates/logisticmap.pug");
/* harmony import */ var _templates_logisticmap_pug__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_templates_logisticmap_pug__WEBPACK_IMPORTED_MODULE_0__);
...
const init = () => {
  ...
  const cobwebChart = new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a(activity.find('#cobwebchart'), {
    type: 'line',
    data: {
      datasets: [
        {
  ...
  const iterationsChart = new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a(activity.find('#iterationschart'), {
    type: 'line',
    data: {
      datasets: [
        {
  ...
  const bifuractionchart = new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a(activity.find('#bifuractionchart'), {
    type: 'scatter',
    data: {
      datasets: [
        // {
...
/***/ "./src/modules/logisticmap/templates/logisticmap.pug":
/*!***********************************************************!*\
  !*** ./src/modules/logisticmap/templates/logisticmap.pug ***!
  \***********************************************************/
/*! no static exports found */
